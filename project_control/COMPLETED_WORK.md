...
## tdf-product-artifact-builder v0.1.0-dev — FOUNDATION_IN_PROGRESS

- Repository initialized
- Generic engine scaffold created
- Reference product spec `lithium_filter_candidate_v0_1` added
