...
## tdf-product-artifact-builder v0.1.0 -- RELEASE-CANDIDATE FINALIZATION IN PROGRESS

- Version metadata bumped to candidate `0.1.0`
- CHANGELOG.md, release notes draft, release candidate checklist added
- Release-readiness audit re-run for release draft readiness
